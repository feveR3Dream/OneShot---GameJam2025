...
[CreateAssetMenu(menuName = "SS Player Movement")]
public class SSMovementStats : ScriptableObject
{
    [Header("Move")]
    ...
    [Header("Run")]
    [Range(1f, 100f)] public float RunSpeed = 20f;
    ...
    [Header("Debug Collision Check")]
    public bool DebugShowGroundedBox;
    public bool DebugShowHeadBumbBox;
